...
function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    // 1. Validation (Keeping Branch ID required)
        ...
        <main className="flex-1 flex items-center justify-center p-4 relative z-10">
          <div className="w-full max-w-[440px] bg-white dark:bg-surface-dark border border-slate-200 dark:border-border-dark shadow-2xl rounded-xl p-8">
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
              <input
                className="form-input w-full h-12 rounded-lg px-4 border border-slate-200 dark:border-border-dark bg-slate-50 dark:bg-[#121617] text-slate-900 dark:text-white focus:ring-2 focus:ring-primary/50 outline-none"
